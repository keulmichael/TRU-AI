...
_STAGE_OBJECTIVES: dict[ReasoningStage, str] = {
    ...
    ReasoningStage.VERIFICATION: "Comparer les prédictions aux observations explicites et qualifier leur compatibilité.",
    ReasoningStage.FALSIFICATION: "Déterminer si les conditions de falsification sont formellement satisfaites.",
...
_STAGE_INPUTS: dict[ReasoningStage, tuple[str, ...]] = {
    ...
    ReasoningStage.PREDICTION: ("theory_graph", "predictions", "prediction_rules", "scenarios"),
    ReasoningStage.VERIFICATION: ("scientific_predictions", "scientific_observations"),
    ReasoningStage.FALSIFICATION: ("scientific_predictions", "verification_reports", "scientific_observations"),
    ...
    ReasoningStage.SYNTHESIS: (
        ...
        "scientific_predictions", "scientific_scenarios", "scenario_simulations", "scientific_observations", "verification_reports", "falsification_reports", "scientific_theory_revisions", "scientific_gaps", "contradictions", "missing_knowledge",
    ),
}
...
_STAGE_OUTPUTS: dict[ReasoningStage, tuple[str, ...]] = {
    ...
    ReasoningStage.PREDICTION: ("scientific_predictions", "scientific_scenarios", "scenario_simulations"),
    ReasoningStage.VERIFICATION: ("scientific_observations", "verification_reports"),
    ReasoningStage.FALSIFICATION: ("falsification_reports", "scientific_theory_revisions"),
